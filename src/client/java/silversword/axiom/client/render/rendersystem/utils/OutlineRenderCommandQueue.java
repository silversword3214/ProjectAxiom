...
import silversword.axiom.mixin.client.OrderedRenderCommandQueueImplAccessor;
...
public class OutlineRenderCommandQueue extends OrderedRenderCommandQueueImpl {
    ...
    public BatchingRenderCommandQueue getBatchingQueue(int i) {
        Int2ObjectAVLTreeMap<BatchingRenderCommandQueue> map = ((OrderedRenderCommandQueueImplAccessor) this).axiom$getBatchingQueues();
